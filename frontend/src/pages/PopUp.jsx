  ...
  return (
    <>
      ...
      <div
        ...
        className="min-h-screen bg-black-50 py-8 px-4 pt-16"
      >
        <div className="rounded-lg w-full max-w-5xl mx-4 flex flex-col sm:flex-row">
          ...
          <div className="p-4 sm:w-1/2">
            ...
            <p className="text-cbrand-300 mb-4">
              🎉 Thanks for choosing to join ComicBoxd! We're excited to have
              you on board. Choose the plan that suits you best and start
              exploring a world of comics!
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              <div className="border border-cbrand-1002 bg-cbrand-1002/10 rounded-lg p-4">
                ...
                <p className="text-cbrand-300 mb-2">
                  Everything in Basic, plus exclusive content, early releases,
